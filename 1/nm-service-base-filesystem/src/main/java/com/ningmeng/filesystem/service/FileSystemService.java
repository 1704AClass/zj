...
import com.ningmeng.filesystem.dao.FileSystemApplication;
...
public class FileSystemService {
    ...
    private void initFdfsConfig(){
        try {
            ...
            e.printStackTrace();
            //初始化文件系统出错
            CustomExceptionCast.cast(FileSystemCode.FS_DELETEFILE_DBFAIL);
        } }
    ...
    public UploadFileResult upload(MultipartFile file,
        ...
        fileSystemApplication.save(fileSystem);
