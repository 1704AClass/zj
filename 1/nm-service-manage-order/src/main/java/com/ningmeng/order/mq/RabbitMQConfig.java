...
public class RabbitMQConfig {
    ...
    //完成添加选课消息队列
    public static final String NM_LEARNING_FINISHADDCHOOSECOURSE =
            "nm_learning_finishaddchoosecourse";
    //添加选课路由key
    ...
    public Queue QUEUE_NM_LEARNING_FINISHADDCHOOSECOURSE() {
        Queue queue = new Queue(NM_LEARNING_FINISHADDCHOOSECOURSE);
        return queue;
    }
    //声明队列
    ...
    @Bean
    public Binding BINDING_QUEUE_ADDCHOOSECOURSE(@Qualifier(NM_LEARNING_ADDCHOOSECOURSE) Queue
