...
public class consumer02_subscribe_sms {
    //发送邮件
    private static final String QUEUE_INFORM_SMSMS="queue_inform_sms";
    //fanout类型的交换器
    ...
    public static void main(String[] args){
        try {
            ...
            channel.queueDeclare(QUEUE_INFORM_SMSMS,true,false,false,null);

            //交换机声明
            channel.exchangeDeclare(EXCHANG_FANOUT_INFORM, BuiltinExchangeType.FANOUT);

            //交换机和队列板顶
            channel.queueBind(QUEUE_INFORM_SMSMS,EXCHANG_FANOUT_INFORM,"");
            ...
            //监听交换机
            channel.basicConsume(QUEUE_INFORM_SMSMS,true,consumer);
        }catch (Exception e){
